        ...
        <div className="flex h-[520px]">
          ...
          <div className="w-[56%] px-10 py-10">
            <div className="text-[13px] text-gray-700 space-y-5">
              {/* location */}
              <div>
                <div className="font-semibold text-gray-800">Meeting location</div>
              ...
              {/* duration */}
              <div>
                <div className="font-semibold text-gray-800">How long do you need?</div>
              ...
              {/* times */}
              <div>
                <div className="font-semibold text-gray-800">What time works best?</div>
                <div className="mt-1 text-gray-600">
                  Showing times for <span className="font-semibold">February 18, 2026</span>
                </div>
